...
bool Program::SetUp()
{
    ...
    this->_vbuffer
            << Vertex<glm::vec3, glm::vec4>({ { -10.0f, -10.0f, 0.0f }, { 1.0f, 1.0f, 1.0f, 255.0f } })
            << Vertex<glm::vec3, glm::vec4>({ { -10.0f, 10.0f, 0.0f }, { 1.0f, 0.0f, 1.0f, 255.0f } })
            << Vertex<glm::vec3, glm::vec4>({ { 10.0f, 10.0f, 0.0f }, { 0.0f, 1.0f, 1.0f, 255.0f } })
            << Vertex<glm::vec3, glm::vec4>({ { 10.0f, -10.0f, 0.0f }, { 1.0f, 1.0f, 0.0f, 255.0f } });
    this->_vbuffer.setup();
...
void Program::OnResize(int width, int height)
{
    ...
    this->_proj = glm::perspective(glm::radians(90.0f), aspect, 0.1f, 4096.0f);
    this->_view = glm::lookAt(
                glm::vec3(this->_pos.x + 10.0f, this->_pos.y + 10.0f, this->_pos.z + 10.0f),
